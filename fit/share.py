...
sh.remove_points_sh = Share()
sh.remove_points_sh.name = "remove_points"
sh.remove_points_sh.epoch = 50

sh.remove_points_sh.smooth_loss = {"mode": "angle_weighted", "w": 0.5}
sh.remove_points_sh.band_loss = {"mode": "midpoint", "w": 100}
sh.remove_points_sh.straightness_loss = {"mode": "tanh", "w": 1}
